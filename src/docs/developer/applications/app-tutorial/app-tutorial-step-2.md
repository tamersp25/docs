...
function loginAndGetToken(username, pw) {
    ...
    let q = 'mutation logMeIn { userLogin(input: {userName: "' + username + '" password: "' + pw + '"}) {token}}';
...
<img width="12%" style="border-radius: 9px;float:left;" src="developer/applications/app-tutorial/_media/botty.png">
<div 
