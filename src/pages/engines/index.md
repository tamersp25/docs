...
Veritone&rsquo;s suite of APIs allow you to build the core strengths of the Veritone Platform into your technology. Our collection of GraphQL APIs support the entire task processing processing lifecycle &mdash; including payload retrieval, task statusing, returning output, and indexing results.
...
1. [Create an Engine: ](/engines/quick-start/step-1-create-an-engine.md)Specify basic information about your engine, including the engine name, description, logo, and deployment model.
...
5. [Submitting a Build for Approval](/engines/quick-start/step-5-submit-build.md): Submit your build for for approval by a member of our team.
