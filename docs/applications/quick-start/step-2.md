...
2. Click the appropriate **application name** in the list. The *Application Settings* open.![client-secret1](VDA-Oauth-Client-Secret-1.png)

3. The *Client ID*, *Client Secret*, and *Redirect URI* display at the top of the page. To retrieve the *Client Secret*, click **Click to reveal**, enter your Veritone password, and click **Submit** (do not press enter on your keyboard).The *C**lient Secret* displays.![client-secret2](VDA-Oauth-Client-Secret-1.png)
