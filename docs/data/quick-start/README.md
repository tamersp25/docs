...
| 3. Enter the following basic details to describe your schema: <br><ul><li>**Data Source**: _(required)_ Enter the source of the data that you're creating the schema for.</li><li>**Schema Description**: _(required)_ Describe what your schema covers in a sentence or two. This description will be displayed to other users of your schema.</li></ul> 4. Click **Next** to continue. The _Create schema_ window opens.| <div style="width: 500px">![](3schema_details.png)</div> |
