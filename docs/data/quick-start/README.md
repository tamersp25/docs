...
| To create a Schema  |                                                                  |
| ------------------- | ---------------------------------------------------------------- |
| 1. Log into [Veritone Developer](https://developer.veritone.com). Click **Overview** in the upper left of the window and select **Data** from the dropdown. The _Data_ page opens. | <div style="width: 500px">![](1vdahome.png)</div> |
