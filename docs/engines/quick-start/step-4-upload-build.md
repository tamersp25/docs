...
|--------|--------|
|Under the engine's *Builds,* click the **vertical ellipsis** on the right of the build in the list and select **Download build report** from the drop-down list. The Build Report downloads to your computer.| <div style="width: 500px">![](/engines/quick-start/VDA-Download-Build-Report.png)</div>|
