...
| category              | string           | Yes      | Yes | The category of the engine that you are providing. The available options are listed in /engines/classes  | "category": "transcription" OR "category": "pull" |
